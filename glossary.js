const GLOSSARY = {
  records: 'Records: individual timestamped samples from the activity file.',
  sessions: 'Sessions: summary records written by the device for this activity.',
  distance: 'Distance: the total recorded distance covered during the activity.',
  duration: 'Duration: the recorded active or elapsed time of the activity.',
  averageSpeed: 'Average speed: total recorded distance divided by the recorded duration or the device-provided average.',
  maximumSpeed: 'Maximum speed: the highest recorded speed after filtering implausible spikes.',
  averagePower: 'Average power: the arithmetic mean of all available power samples.',
  maximumPower: 'Maximum power: the highest available power sample.',
  ...
  maximumHeartRate: 'Maximum heart rate: the highest available heart-rate sample.',
  elevationGain: 'Elevation gain: the total of positive altitude changes after elevation smoothing.',
  elevationLoss: 'Elevation loss: the total of negative altitude changes after elevation smoothing.',
  gpsPoints: 'GPS points: recorded samples with a usable geographic position.',
